...
public class InvestorForm extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cb3=findViewById(R.id.i_expertise_marketing);
        cb4=findViewById(R.id.i_expertise_operation);
                ...
                reference.updateChildren(updatedData)
                        ...
                        .addOnFailureListener(new OnFailureListener() {
                            ...
                            public void onFailure(@NonNull Exception e) {
                                Toast.makeText(InvestorForm.this, "Failed to update user", Toast.LENGTH_LONG).show();
                            }
                        });
